      ...
      <div className="container">
                  ...
                  <div className="ms-3">
                    ...
                    <div>
                      ...
                      <span className="text-sm font-medium inline-block me-1">
                        {item.deta}{" "}
                        <span className="text-slate-400">{item.deta1}</span>
                      </span>
                      <span className="text-sm font-medium inline-block me-1">
                        {item.deta2}{" "}
                        <span className="text-slate-400">{item.deta3}</span>
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="px-6 py-2 bg-slate-50 dark:bg-slate-800 lg:flex justify-between items-center">
                <div className="lg:inline-block flex justify-between items-center">
                  <span className="inline-block me-1 font-semibold">
                    <i className="mdi mdi-check-decagram mdi-18px text-blue-500 me-1"></i>
                    {item.verify}
                  </span>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 mt-8">
          <div className="md:col-span-12 text-center">
            ...
            >
              See More Jobs <MdOutlineArrowForward className="m-1" />
            </Link>
          </div>
        </div>
      </div>
