        ...
        <div className="container">
          <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
            {CandidateList.slice(0, 4).map((item, index) => (
              <div
                className="group bg-white dark:bg-slate-900 relative overflow-hidden rounded-md shadow dark:shadow-gray-700 text-center p-6"
                key={index}
              >
                <img
                  src={item.image}
                ...
                <div className="mt-3">
                  ...
                  <Link
                    to="#"
                    className="btn btn-sm btn-icon bg-emerald-600/5 hover:bg-emerald-600 border-emerald-600/10 hover:border-emerald-600 text-emerald-600 hover:text-white rounded-full ms-1"
                  >
