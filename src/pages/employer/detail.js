...
import { BiLogoDribbble ,BiLogoLinkedin, BiDollarCircle} from 'react-icons/bi';
import { AiOutlineBehance,AiOutlineClockCircle } from 'react-icons/ai';
...
export default function EmployerDetail(props) {
    ...
    return (
        <>
            ...
            <section className="relative w-full py-40 bg-[url('../../assets/images/hero/bg4.jpg')] bg-center bg-no-repeat bg-cover">
