              ...
              <div className="relative">
                ...
                <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                  <Link
                    ...
                    data-type="youtube"
                    data-id="S_CGed6E610"
                    className="lightbox h-20 w-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-emerald-600 dark:text-white"
                  >
            ...
            <div className="lg:col-span-7 md:col-span-6">
              <div className="lg:ms-8">
                ...
                <div className="mt-6">
                  <Link
                    to="/contact"
                    className="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white mt-2 rounded-md inline-flex items-center"
                  >
                    <LuMail className="me-1" /> Contact us
                  </Link>
                </div>
              </div>
            </div>
